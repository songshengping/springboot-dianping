...
public class GlobalExceptionHandler {
    ...
    public @ResponseBody APIResponse<String> handleParamNullException(ParamNullException ex) {
    ...
    public @ResponseBody APIResponse<String> handleShellCommandException(ShellCommandException ex) {
    ...
    public @ResponseBody APIResponse<String> handleGeneralException(GeneralException ex) {
